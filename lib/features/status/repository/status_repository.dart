...
class StatusRepository {
  ...
  void uploadStatus({
    ...
    try {
      ...
      String uploadedImageUrl = await ref.read(commonFirebaseStorageRepositoryProvider).storeFileToFirebase(
            "/status/$statusId$uid",
            statusImage,
          );
      ...
      if (statusesSnapshot.docs.isNotEmpty) {
        ...
        statusImageUrls.add(uploadedImageUrl);
        await firestore
            .collection("status")
            .doc(
        ...
        statusImageUrls = [uploadedImageUrl];
      }
